...
public class SmithingFlowArmorTrimRecipe implements RecipeGeneratorHelper {
    @Override
...
""";
        ...
        File outputFile = new File(directory, "smithing_flow_armortrim.json");
        try (FileWriter writer = new FileWriter(outputFile)) {
            writer.write(recipeJson);
        } catch (IOException e) {
            System.err.println("Failed to write flow armor trim recipe file: " + e.getMessage());
        }
    }
}