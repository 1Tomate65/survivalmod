...
public class SmithingEyeArmorTrimRecipe implements RecipeGeneratorHelper {
    @Override
...
""";
        ...
        File outputFile = new File(directory, "smithing_eye_armortrim.json");
        try (FileWriter writer = new FileWriter(outputFile)) {
            writer.write(recipeJson);
        } catch (IOException e) {
            System.err.println("Failed to write eye armor trim recipe file: " + e.getMessage());
        }
    }
}