...
public class SmithingSpireArmorTrimRecipe implements RecipeGeneratorHelper {
    @Override
...
""";
        ...
        File outputFile = new File(directory, "smithing_spire_armortrim.json");
        try (FileWriter writer = new FileWriter(outputFile)) {
            writer.write(recipeJson);
        } catch (IOException e) {
            System.err.println("Failed to write spire armor trim recipe file: " + e.getMessage());
        }
    }
}