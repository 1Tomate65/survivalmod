...
public class SmithingRibArmorTrimRecipe implements RecipeGeneratorHelper {
    @Override
...
""";
        ...
        File outputFile = new File(directory, "smithing_rib_armortrim.json");
        try (FileWriter writer = new FileWriter(outputFile)) {
            writer.write(recipeJson);
        } catch (IOException e) {
            System.err.println("Failed to write rib armor trim recipe file: " + e.getMessage());
        }
    }
}