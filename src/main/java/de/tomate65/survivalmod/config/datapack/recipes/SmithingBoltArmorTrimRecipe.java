...
public class SmithingBoltArmorTrimRecipe implements RecipeGeneratorHelper {
    @Override
...
""";
        ...
        File outputFile = new File(directory, "smithing_bolt_armortrim.json");
        try (FileWriter writer = new FileWriter(outputFile)) {
            writer.write(recipeJson);
        } catch (IOException e) {
            System.err.println("Failed to write bolt armor trim recipe file: " + e.getMessage());
        }
    }
}