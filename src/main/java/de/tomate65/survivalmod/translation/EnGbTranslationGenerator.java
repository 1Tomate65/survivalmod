...
public class EnGbTranslationGenerator extends TranslationGenerator {
    ...
    public JsonObject generateTranslations() {
        ...
        // For formatted chat messages (required by ToggleRenderer)
    ...
    private void addClearCommandTranslations(JsonObject translations) {
        ...
        translations.addProperty("help.clear.partial_colors", "- /toggle clear colour - All colours");
        translations.addProperty("help.clear.partial_color_types", "- /toggle clear colour <type> - Specific colour");
