...
public class RecipeHandler {
    private static final File RECIPE_DIR = new File("config/survival/" + ConfigReader.getModVersion() + "/recipe");
    private static final File TOGGLE_FILE = new File("config/survival/" + ConfigReader.getModVersion() + "/recipe_toggles.json");
    ...
    public static void initialize() {
        createDirectories();
        loadToggles();  // Only load toggles, don't generate recipes
    }
